...
<div class="padding-md">
	<div class="padding-md border border-radius-lg">
		<div class="display-flex flex-direction-column flex-direction-row-tablet gap-md">
			<div class="image image-128x128" aria-hidden="true">${shakespeareSvgMarkup}</div>
			<div>
 ...
 * @param {string} outDir
 */
export async function generateHtmlReport(manifest: VisualDiffReportManifest) {
