...
| URI                   | Contents                                                                  |
| --------------------- | ------------------------------------------------------------------------- |
| `atlas://composition` | Composition guide: the outside-in build order and structural dependencies |
