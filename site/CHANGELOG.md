...
- fc22fe5: Add syntax highlighting styles for documentation code blocks.
...
- 83cd78b: Migrate the documentation site build from Parcel to Eleventy (11ty).
...
- 5ddf13fc: Updating testimonial card pattern with persona component usage.
