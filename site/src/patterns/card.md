...
This card type contains a super title labelled the card's type, a title, an icon, and a section to place metadata specific to the content type. Its footer has two sections: a lefthand secton for status and progress, and a righthand section for buttons.
