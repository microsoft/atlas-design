...
For async failures that can happen with such things like captcha we catch the error and can add a message for the failure.
...
<form
	...
	method="POST"
	novalidate=""
	test-async-before-submit-failure
>
	<form-behavior
		new
		navigation="reload"
